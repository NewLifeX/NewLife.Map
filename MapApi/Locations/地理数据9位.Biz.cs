...
public partial class Geo9 : Entity<Geo9>, IGeo
{
    #region 对象操作
    static Geo9()
    {
    ...
    public override void Valid(Boolean isNew)
    {
        ...
        if (Hash.IsNullOrEmpty() && Longitude != 0) Hash = GeoHash.Encode(Longitude, Latitude, 9);
        //if (HashBd09.IsNullOrEmpty()) HashBd09 = GeoHash.Encode(LongitudeBd09, LatitudeBd09, 9);
    ...
    public static Geo9 FindById(Int32 id)
    {
        if (id <= 0) return null;
    ...
    public static Geo9 FindByHash(String hash, Boolean cache)
    {
        if (hash.IsNullOrEmpty()) return null;

        if (cache)
            return Meta.SingleCache.GetItemWithSlaveKey(hash) as Geo9;
        else
    ...
    /// <returns></returns>
    public static Geo9 FindByHash(GeoPoint point)
    {
    ...
    /// <param name="point"></param>
    /// <returns></returns>
    public static Geo9 FindByHashBd09(GeoPoint point)
    {
        if (point == null) return null;
    ...
    /// <param name="point"></param>
    /// <returns></returns>
    public static Geo9 FindByHashGcj02(GeoPoint point)
    {
        if (point == null) return null;
    ...
    public static IList<Geo9> FindAllByCode(Int32 code)
    {
        // 实体缓存
    ...
    /// <returns>实体列表</returns>
    public static IList<Geo9> FindAllByProvinceIdAndCityIdAndDistrictId(Int32 provinceId, Int32 cityId, Int32 districtId)
    {
        // 实体缓存
    ...
    /// <returns>实体列表</returns>
    public static IList<Geo9> Search(Int32 code, Int32 provinceId, Int32 cityId, Int32 districtId, DateTime start, DateTime end, String key, PageParameter page)
    {
    ...
    public static Geo9 Upsert(GeoAddress geoAddress, GeoPoint wgs84, GeoPoint bd09, GeoPoint gcj02, Int32 days)
    {
        Geo9 onCreate(GeoPoint k)
        {
            var gd = new Geo9 { CreateTime = DateTime.Now };
    ...
    public void Fill(GeoAddress geo, GeoPoint wgs84, GeoPoint bd09, GeoPoint gcj02)
    {
        ...
        if (wgs84 != null)
        {
            ...
            if (wgs84.Longitude != 0) Hash = GeoHash.Encode(wgs84.Longitude, wgs84.Latitude, 9);
        }
        ...
        if (bd09 != null)
        {
            ...
            HashBd09 = GeoHash.Encode(bd09.Longitude, bd09.Latitude, 9);
        }
