...
public partial class Geo9 : Entity<Geo9>, IGeo
{
    ...
    public override void Valid(Boolean isNew)
    {
        ...
        if (Hash.IsNullOrEmpty()) Hash = GeoHash.Encode(Longitude, Latitude, 9);
    ...
    public static Geo9 Upsert(GeoPoint point, GeoAddress geoAddress, GeoPoint bd09, GeoPoint gcj02, Int32 days)
    {
        ...
        {
            var gd = new Geo9 { Hash = k, CreateTime = DateTime.Now };
    ...
    public static Geo9 GetOrAdd(GeoPoint point)
    {
        var hash = GeoHash.Encode(point.Longitude, point.Latitude, 9);
        return GetOrAdd(hash);
    }

    public static Geo9 GetOrAdd(String hash) => GetOrAdd(hash, FindByHash, k => new Geo9 { Hash = k, CreateTime = DateTime.Now });
