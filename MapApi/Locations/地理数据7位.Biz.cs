...
public partial class Geo7 : Entity<Geo7>, IGeo
{
    #region 对象操作
    static Geo7()
    {
    ...
    public override void Valid(Boolean isNew)
    {
        ...
        if (Hash.IsNullOrEmpty() && Longitude != 0) Hash = GeoHash.Encode(Longitude, Latitude, 7);
        //if (HashBd09.IsNullOrEmpty()) HashBd09 = GeoHash.Encode(LongitudeBd09, LatitudeBd09, 7);
    ...
    public static Geo7 FindById(Int32 id)
    {
        if (id <= 0) return null;
    ...
    public static Geo7 FindByHash(String hash, Boolean cache)
    {
        if (hash.IsNullOrEmpty()) return null;

        if (cache)
            return Meta.SingleCache.GetItemWithSlaveKey(hash) as Geo7;
        else
    ...
    /// <returns></returns>
    public static Geo7 FindByHash(GeoPoint point)
    {
        if (point == null) return null;

        var hash = GeoHash.Encode(point.Longitude, point.Latitude, 7);
        return Meta.SingleCache.GetItemWithSlaveKey(hash) as Geo7;
    }
    ...
    /// <param name="point"></param>
    /// <returns></returns>
    public static Geo7 FindByHashBd09(GeoPoint point)
    {
        if (point == null) return null;
    ...
    /// <param name="point"></param>
    /// <returns></returns>
    public static Geo7 FindByHashGcj02(GeoPoint point)
    {
        if (point == null) return null;
    ...
    public static IList<Geo7> FindAllByCode(Int32 code)
    {
        // 实体缓存
    ...
    /// <returns>实体列表</returns>
    public static IList<Geo7> FindAllByProvinceIdAndCityIdAndDistrictId(Int32 provinceId, Int32 cityId, Int32 districtId)
    {
        // 实体缓存
    ...
    /// <returns>实体列表</returns>
    public static IList<Geo7> Search(Int32 code, Int32 provinceId, Int32 cityId, Int32 districtId, DateTime start, DateTime end, String key, PageParameter page)
    {
    ...
    public static Geo7 Upsert(GeoAddress geoAddress, GeoPoint wgs84, GeoPoint bd09, GeoPoint gcj02, Int32 days)
    {
        Geo7 onCreate(GeoPoint k)
        {
            var gd = new Geo7 { CreateTime = DateTime.Now };
    ...
    public void Fill(GeoAddress geo, GeoPoint wgs84, GeoPoint bd09, GeoPoint gcj02)
    {
        ...
        if (wgs84 != null)
        {
            ...
            if (wgs84.Longitude != 0) Hash = GeoHash.Encode(wgs84.Longitude, wgs84.Latitude, 7);
        }
        ...
        if (bd09 != null)
        {
            ...
            HashBd09 = GeoHash.Encode(bd09.Longitude, bd09.Latitude, 7);
        }
        ...
        if (gcj02 != null)
        {
            ...
            HashGcj02 = GeoHash.Encode(gcj02.Longitude, gcj02.Latitude, 7);
        }
    }
    #endregion
}