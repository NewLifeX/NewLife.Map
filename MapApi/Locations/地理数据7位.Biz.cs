...
public partial class Geo7 : Entity<Geo7>, IGeo
{
    ...
    public override void Valid(Boolean isNew)
    {
        ...
        if (Hash.IsNullOrEmpty()) Hash = GeoHash.Encode(Longitude, Latitude, 7);
    ...
    public static Geo7 Upsert(GeoPoint point, GeoAddress geoAddress, GeoPoint bd09, GeoPoint gcj02, Int32 days)
    {
        var hash = GeoHash.Encode(point.Longitude, point.Latitude, 7);
        var g = GetOrAdd(hash, FindByHash, k =>
        {
            var gd = new Geo7 { Hash = k, CreateTime = DateTime.Now };
    ...
    public static Geo7 GetOrAdd(GeoPoint point)
    {
        var hash = GeoHash.Encode(point.Longitude, point.Latitude, 7);
        return GetOrAdd(hash);
    }

    public static Geo7 GetOrAdd(String hash) => GetOrAdd(hash, FindByHash, k => new Geo7 { Hash = k, CreateTime = DateTime.Now });
