...
public partial class Geo6 : Entity<Geo6>, IGeo
{
    #region 对象操作
    static Geo6()
    {
    ...
    public override void Valid(Boolean isNew)
    {
        ...
        var len = _.Address.Length;
        if (len > 0 && Address != null && Address.Length > len) Address = Address[..len];
    ...
    public static Geo6 FindById(Int32 id)
    {
        if (id <= 0) return null;
    ...
    public static Geo6 FindByHash(String hash, Boolean cache)
    {
    ...
    /// <returns></returns>
    public static Geo6 FindByHash(GeoPoint point)
    {
    ...
    public static IList<Geo6> FindAllByCode(Int32 code)
    {
        // 实体缓存
    ...
    /// <returns>实体列表</returns>
    public static IList<Geo6> Search(Int32 code, Int32 provinceId, Int32 cityId, Int32 districtId, DateTime start, DateTime end, String key, PageParameter page)
    {
    ...
    // Select Count(Id) as Id,Category From Geo6 Where CreateTime>'2020-01-24 00:00:00' Group By Category Order By Id Desc limit 20
    //static readonly FieldCache<Geo6> _CategoryCache = new FieldCache<Geo6>(nameof(Category))
    //{
    ...
    public void Fill(GeoAddress geo, GeoPoint wgs84, GeoPoint bd09, GeoPoint gcj02)
    {
        ...
        if (bd09 != null)
        {
            ...
            HashBd09 = GeoHash.Encode(bd09.Longitude, bd09.Latitude, 6);
        }
        ...
        if (gcj02 != null)
        {
            ...
            HashGcj02 = GeoHash.Encode(gcj02.Longitude, gcj02.Latitude, 6);
        }
    }
    #endregion
}