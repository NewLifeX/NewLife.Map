...
namespace MapApi.Locations
{
    ...
    [Serializable]
    [DataObject]
    [Description("地理数据8位。根据GeoHash索引地理解析数据，8位精度19米")]
    [BindIndex("IX_Geo8_Hash", false, "Hash")]
    [BindIndex("IX_Geo8_HashBd09", false, "HashBd09")]
    [BindIndex("IX_Geo8_HashGcj02", false, "HashGcj02")]
    [BindIndex("IX_Geo8_Code", false, "Code")]
    [BindIndex("IX_Geo8_ProvinceId_CityId_DistrictId", false, "ProvinceId,CityId,DistrictId")]
    [BindTable("Geo8", Description = "地理数据8位。根据GeoHash索引地理解析数据，8位精度19米", ConnName = "Geo8", DbType = DatabaseType.None)]
    public partial class Geo8
    {
        #region 属性
        private Int32 _Id;
        /// <summary>编号</summary>
        ...
        [DisplayName("gcj02经度")]
        [Description("gcj02经度。高德坐标")]
        [DataObjectField(false, false, false, 0)]
        [BindColumn("LongitudeGcj02", "gcj02经度。高德坐标", "")]
        ...
        /// <summary>gcj02纬度。高德坐标</summary>
        [DisplayName("gcj02纬度")]
        [Description("gcj02纬度。高德坐标")]
        [DataObjectField(false, false, false, 0)]
        [BindColumn("LatitudeGcj02", "gcj02纬度。高德坐标", "")]
        ...
        #region 字段名
        /// <summary>取得地理数据8位字段信息的快捷方式</summary>
        ...
        /// <summary>取得地理数据8位字段名称的快捷方式</summary>
